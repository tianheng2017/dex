...
export default function RemoveLiquidity({
        ...
        return (
            <AutoColumn gap={'md'} style={{ marginTop: '20px' }}>
                ...
                <TYPE.italic fontSize={12} color={theme.text2} textAlign="left" padding={'12px 0 0 0'}>
                    {`输出是估计值。如果价格变化超过 ${allowedSlippage /
                        100}％，您的交易将回滚`}
                </TYPE.italic>
            </AutoColumn>
        )
            ...
            <>
                <RowBetween>
                    <Text color={theme.text2} fontWeight={500} fontSize={16}>
                        {currencyA?.symbol + '/' + currencyB?.symbol} 流动池通证销毁
                    </Text>
                    <RowFixed>
    ...
    const pendingText = `移除 ${parsedAmounts[Field.CURRENCY_A]?.toSignificant(6)} ${currencyA?.symbol
